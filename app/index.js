...
// Dummy product list
const products = [
  { id: 1, name: "Laptop", price: 800, img: "https://source.unsplash.com/300x200/?laptop" },
  { id: 2, name: "Phone", price: 500, img: "https://source.unsplash.com/300x200/?smartphone" },
  { id: 3, name: "Headphones", price: 100, img: "https://source.unsplash.com/300x200/?headphones" },
  { id: 4, name: "Smartwatch", price: 200, img: "https://source.unsplash.com/300x200/?smartwatch" }
];
...
app.get("/", (req, res) => {
  ...
  res.send(`
    <html>
      ...
      <body>
        <header>
          <h1>🚀 Welcome to My Cool E-commerce Store</h1>
          <div class="nav">
            <a href="/">🏠 Home</a>
            <a href="/cart">🛒 Cart</a>
